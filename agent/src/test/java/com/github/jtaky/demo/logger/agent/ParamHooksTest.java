...
import com.github.jtaky.logger.agent.MethodCall;
import com.github.jtaky.logger.agent.ParameterStorage;
...
public class ParamHooksTest {
	...
	public void testPrimitiveTypes(){
        f(12, 0.33, () -> {
            ...
            Assert.assertEquals("com.github.jtaky.demo.logger.agent.ParamHooksTest",  fCall.className());
    ...
    public void testConstructorParameters(){
        new F(12, "some string", () -> {
            ...
            MethodCall fCall = methodCallList.get(0);
            Assert.assertEquals("com.github.jtaky.demo.logger.agent.ParamHooksTest$F",  fCall.className());
